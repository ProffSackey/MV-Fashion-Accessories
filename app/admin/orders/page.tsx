...
import { MagnifyingGlassIcon, FunnelIcon, ArrowDownTrayIcon, EyeIcon, EnvelopeIcon, EllipsisVerticalIcon, HomeIcon, UserGroupIcon, ShoppingCartIcon, CubeIcon, CreditCardIcon, ChartBarIcon, StarIcon, GiftIcon, BellIcon, NewspaperIcon, CogIcon } from "@heroicons/react/24/outline";
...
export default function OrdersPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        <AdminSidebar active="orders" mobileOpen={mobileMenuOpen} onMobileClose={() => setMobileMenuOpen(false)} />
