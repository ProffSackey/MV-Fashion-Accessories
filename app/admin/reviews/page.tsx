...
import { MagnifyingGlassIcon, FunnelIcon, HomeIcon, UserGroupIcon, ShoppingCartIcon, CubeIcon, CreditCardIcon, ChartBarIcon, StarIcon, GiftIcon, BellIcon, EnvelopeIcon, NewspaperIcon, CogIcon, SparklesIcon } from "@heroicons/react/24/outline";
...
export default function AdminReviewsPage() {
  ...
  return (
    <div className="min-h-screen text-gray-800 bg-gray-50">
      ...
      <div className="flex">
        <AdminSidebar active="reviews" mobileOpen={mobileMenuOpen} onMobileClose={() => setMobileMenuOpen(false)} />
